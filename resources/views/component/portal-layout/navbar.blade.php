<header
    ...
    <div class="d-md-flex py-2 gap-4 align-items-center d-none z-2 justify-content-end ms-auto">
        <a href="/student-list" class="text-decoration-none text-white fw-semibold" style="font-size: 18px">List Murid</a>
        <a href="/teacher-list" class="text-decoration-none text-white fw-semibold" style="font-size: 18px">List Guru
            Kami</a>
        <a href="/event-list" class="text-decoration-none text-white fw-semibold"
